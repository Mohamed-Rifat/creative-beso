          ...
          <div className="relative w-full py-10 overflow-x-hidden md:overflow-x-visible">
            ...
            <div className="relative overflow-hidden">
              ...
              <motion.div
                ...
                className="text-center mt-16"
              >
                <Link to="/clients" className="inline-flex items-center px-10 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-lg font-semibold rounded-full shadow-2xl hover:shadow-purple-500/30 transform hover:-translate-y-1 transition-all duration-300">
                  All Clients
                  <svg className="w-5 h-5 ml-3 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"></path>
                  </svg>
